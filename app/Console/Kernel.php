    ...
    protected function schedule(Schedule $schedule)
    {
        $schedule->call(function () {
            ...
            foreach ($data as $object) {
                ...
                if (preg_match(
                    '(microsoft|ovh|DIGITALOCEAN|AMAZO-ZPDX|MSFT|qwant|liquidweb|TencentCloud|Unicom|VIAWEST-BLK|GOOGL|SHINJIRU|CDN77|EONSCOPE|EstNOC-Malaysia|CONTABO|AMAZON|ALICLOUD|Baidu|UK2-INFRA|Arin|Dream|GoDaddy|Hetzner|Linode|Ripe|Facebook|Opera|Zscaler|Nokia|Kaspersky)i',
                    $provider
                ) === 1) {
                    $object->delete();
                }
